...
public class RegisterView {
    public RegisterView(JFrame frame, JPanel loginPanel) {
        ...
        // Close button for the terms panel
        ...
        termsPanel.setVisible(false); // Initially hide the termsPanel
    ...
    private void showTermsWindow(String termsInfo) {
        ...
        termsFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Close only the termsFrame, not the main frame
